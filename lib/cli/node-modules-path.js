...
/**
  ...
  Using this method to discover the correct location of the `node_modules`
  directory allows addons to be looked up properly even when the `node_modules`
  directory is outside of the project's root.

  This method checks the env variable `EMBER_NODE_PATH`. If present, this value
